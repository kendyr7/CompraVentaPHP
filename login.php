...
<head>
    <meta charset="utf-8" />
    <title>Acceso | InventorPRO </title>
                            ...
                            <div class="row g-0">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Todo bajo control con InventorPRO: tu ferretería, tu inventario, tu facturación "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Gestiona tu ferretería con facilidad: InventorPRO, tu aliado digital."</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Deja las complicaciones atrás: Facturación e inventario eficiente con InventorPRO "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="fs-1 fw-bold">Bienvenido!</h5>
                                            <p class="text-muted fs-5">Acceder a <img src="assets/images/logo-dark.png" alt="" height="15"></p>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                            <script>document.write(new Date().getFullYear())</script> InventorPRO. Developed by Kendyr Quintanilla
                            </p>
                        </div>
                    </div>
                </div>
